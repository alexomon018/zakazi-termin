...
export function CookieBanner() {
  const { hasConsented, isHydrated, acceptAll, acceptNecessaryOnly } =
    useCookieConsent();
      ...
      <div className="flex flex-col gap-4 justify-between items-center mx-auto max-w-7xl md:flex-row">
        <div className="text-sm text-center text-muted-foreground md:text-left">
          <p className="mb-1 font-semibold text-foreground">
            Kolačići za bolje iskustvo
          </p>
          <p>
            Koristimo neophodne kolačiće da bi sajt radio ispravno, a uz tvoju
            dozvolu i analitičke kolačiće za unapređenje platforme. Podešavanja
            možeš promeniti u bilo kom trenutku. Više informacija potraži u
            našoj{" "}
