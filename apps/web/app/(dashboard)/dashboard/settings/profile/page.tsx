      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Vaša profilna slika će se prikazivati na stranici za
                  zakazivanje.
                </p>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="bio" className="text-gray-900 dark:text-white">O vama</Label>
              <textarea
                id="bio"
                {...register("bio")}
                rows={3}
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              <Label htmlFor="timeZone" className="text-gray-900 dark:text-white">Vremenska zona</Label>
              <select
                id="timeZone"
                {...register("timeZone")}
